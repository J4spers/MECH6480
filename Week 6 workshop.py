...
ux_y_verification = udata['y']
ux_verification = udata['x50']
uy_x_verification = vdata['x']
uy_verification = vdata['y50']
u_compare = u[int(NX/2),1:-1]
v_compare = v[1:-1, int(NY/2)]
fig, (ax1, ax2) = plt.subplot(1,2, figsize=(12,6))
ax1.plot(ux_y_verification, ux_verification, 'ro',\
         label='ref data')
ax1.plot(ynodes, u_compare, 'b-', \
         label='simulation')
ax1.set_xlabel('y')
ax1.set_ylabel('u')

ax2.plot(uy_x_verification, uy_verification, 'ro',\
         label='ref data')
ax2.plot(xnodes, v_compare, 'b-', \
         label='simulation')
ax2.set_xlabel('x')
ax2.set_ylabel('v')
plt.show()